...
// ============================================================================
// DISABLED: RSS-only mode - text extraction and summarization removed

// /**
//  * Tests text extraction and summarization on a single article
//  * For admin testing purposes
//  * DISABLED in RSS-only mode
//  */
// export const testTextExtraction = onCall(async (request) => {
//   requireAuth(request);
//   throw new HttpsError("unimplemented", "Text extraction disabled in RSS-only mode");
// });
